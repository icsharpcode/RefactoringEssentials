...
namespace RefactoringEssentials.CSharp.Diagnostics
{
    ...
    public class ReplaceWithSingleCallToLongCountAnalyzer : DiagnosticAnalyzer
    {
        static readonly DiagnosticDescriptor descriptor = new DiagnosticDescriptor(
            CSharpDiagnosticIDs.ReplaceWithSingleCallToLongCountAnalyzerID,
            ...
            helpLinkUri: HelpLink.CreateFor(CSharpDiagnosticIDs.ReplaceWithSingleCallToLongCountAnalyzerID)
        );
